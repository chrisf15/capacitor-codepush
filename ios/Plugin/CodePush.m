...
@property (readwrite, assign, nonatomic) BOOL ignoreNextResume;
...
bool shouldIgnoreNextResume = false;
...
- (void)ignoreNextResume:(CAPPluginCall *)call {
    shouldIgnoreNextResume = true;
    [call resolve];
}
...
- (void)applicationWillEnterForeground {
    if (shouldIgnoreNextResume) {
        shouldIgnoreNextResume = false;
        return;
    }
