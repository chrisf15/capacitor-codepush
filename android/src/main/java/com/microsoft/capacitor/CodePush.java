...
public class CodePush extends Plugin {
    ...
    private boolean shouldIgnoreNextResume = false;
    ...
    @PluginMethod()
    public void ignoreNextResume(PluginCall call) {
    ...
    public void handleOnStart() {
        ...
        if (!didStartApp) {
            ...
            if (this.shouldIgnoreNextResume) {
                this.shouldIgnoreNextResume = false;
                return;
            }
